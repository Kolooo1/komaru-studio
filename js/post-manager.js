...
const defaultPosts = [
    ...
    {
        id: 'permanent',
        title: 'Демонстрация модели героя',
        preview: 'Поговорим о модели героя и процессе разработки.',
        content: 'Здравствуйте, дорогие друзья! С вами Zernet_74, и я с радостью представляю нашу творческую команду! Я выступаю в роли аниматора, внося свой вклад в создание увлекательных проектов. На данный момент мы активно работаем над новым амбициозным проектом — динамичным шутером, который обещает подарить массу эмоций! Сегодня я с гордостью делюсь с вами первым скриншотом, который демонстрирует начальный этап разработки и даёт представление о том, что ждёт вас в нашей игре. Будем рады вашим отзывам и поддержке!.',
        author: 'admin',
        authorName: 'Администратор',
        date: '2025-06-15',
